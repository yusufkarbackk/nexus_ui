        ...
        <section className="border-t border-slate-800 bg-slate-900/30 px-6 py-12">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <Link
                href="/agents"
                className="group p-5 bg-slate-900 rounded-xl border border-slate-800 hover:border-cyan-500/50 transition-all duration-200"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-white group-hover:text-cyan-400 transition-colors text-sm">
                      Agent Config
                    </h3>
                    <p className="text-xs text-slate-400 truncate">
                      Generate config
